...
```{r mod3 apendix,fig.pos="H",fig.align='left',fig.cap="ACF and PACF of the serie and the model 3."}
acfts(ipi.t)
acfmodel(mod3bis)
```
...
```{r mod4 appendix,fig.pos="H",fig.align='left',fig.cap="ACF and PACF of the serie and the model 4."}
acfts(ipi.t)
acfmodel(mod4bis)
```
...
```{r ljung4 appendix,fig.pos="H",fig.align='left',fig.cap="P-values of the Ljung-Box tests. \\label{ljung4}"}
ljungggplot(mod4bis)
```
