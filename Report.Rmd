...
```{r monthplot,fig.pos="H",fig.align='left',fig.cap="Decomposition of log(ipi). \\label{monthplot}"}
...
qqggplot(mod3bis)
hist(mod3bis$residuals,breaks=20,freq=F,main="")
...
```{r predlin,fig.pos="H",fig.align='left',fig.cap="Predictions and confidence interval obtained with the linearized truncated model. \\label{predlin}"}
